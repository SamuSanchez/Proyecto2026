...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    */
    private void checkRole(SysRole role){
        ...
        if (list != null && !list.isEmpty()){
            throw new BadRequestException("El codigo o nombre del rol ya existe, vuelve a intentarlo");
        }
    }
    ...
    */
    private void checkRoleUser(Long roleId){
        ...
        if (!CollectionUtils.isEmpty(list)){
            throw new BadRequestException("Este rol esta asociado a usuarios; desvinculalo antes de eliminar");
        }
    }
}
